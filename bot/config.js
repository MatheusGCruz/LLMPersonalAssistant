...
const DEFAULT_ROUTES = [
  {
    ...
    endpoint: 'http://host.docker.internal:3021/mp3/{url}',
    method: 'GET',
    filename: 'audio.mp3',
...
const config = {
  ...
  openrouterEnabled: String(process.env.BOT_OPENROUTER_ENABLED ?? 'true') === 'true',
  openrouterApiKey: process.env.BOT_OPENROUTER_API_KEY || process.env.OPENROUTER_API_KEY || '',
  openrouterBaseUrl: process.env.BOT_OPENROUTER_BASE_URL || 'https://openrouter.ai/api/v1',
  openrouterModel: process.env.BOT_OPENROUTER_MODEL || 'openrouter/free',
  openrouterTimeoutMs: parseIntValue(process.env.BOT_OPENROUTER_TIMEOUT_MS, 120000),
